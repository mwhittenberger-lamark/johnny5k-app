...
export const ironquestApi = {
  ...
  generateCharacterSheetPortrait: (payload = {}) => api.post('/ironquest/character-sheet/portrait', payload),
  generateWorldArt: (payload = {}) => api.post('/ironquest/world-art/generate', payload),
  worldArtBlob: (artKey) => api.blob(`/ironquest/world-art/${encodeURIComponent(artKey)}`),
