...
export const workoutApi = {
  ...
  getSavedLibrary: () => api.get('/workout/saved-library'),
  saveSavedWorkout: (data) => api.post('/workout/saved-library', data),
  queueSavedWorkout: (id) => api.post(`/workout/saved-library/${id}/queue`, {}),
  deleteSavedWorkout: (id) => api.del(`/workout/saved-library/${id}`),
