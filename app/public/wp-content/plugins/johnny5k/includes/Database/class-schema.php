...
class Schema {
  ...
  UNIQUE KEY user_id (user_id)
			...
			/* ── User Preferences ──────────────────────────────────────────────── */
			"CREATE TABLE {$p}user_preferences (
  id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  user_id bigint(20) unsigned NOT NULL,
  ...
  UNIQUE KEY user_id (user_id)
			...
			/* ── User Health Flags ─────────────────────────────────────────────── */
			"CREATE TABLE {$p}user_health_flags (
  id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  user_id bigint(20) unsigned NOT NULL,
  ...
  KEY substitute_exercise_id (substitute_exercise_id)
			...
			/* ── Program Templates ─────────────────────────────────────────────── */
			"CREATE TABLE {$p}program_templates (
  id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  name varchar(150) NOT NULL,
  goal_type enum('cut','maintain','gain','recomp') NOT NULL DEFAULT 'maintain',
  ...
  KEY program_template_id (program_template_id)
			...
			"CREATE TABLE {$p}program_template_exercises (
  id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  ...
  KEY exercise_id (exercise_id)
			...
			/* ── User Training Plans ───────────────────────────────────────────── */
			"CREATE TABLE {$p}user_training_plans (
  id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  user_id bigint(20) unsigned NOT NULL,
  ...
  KEY training_plan_id (training_plan_id)
			...
			/* ── User Training Day Exercises ───────────────────────────────────── */
			"CREATE TABLE {$p}user_training_day_exercises (
  id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  ...
  KEY user_updated (user_id,updated_at)
			...
			/* ── Workout Sessions ──────────────────────────────────────────────── */
			"CREATE TABLE {$p}workout_sessions (
  id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  user_id bigint(20) unsigned NOT NULL,
  ...
  KEY user_completed (user_id,completed)
			...
			"CREATE TABLE {$p}workout_session_exercises (
  id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  ...
  KEY session_exercise_id (session_exercise_id)
			...
			"CREATE TABLE {$p}exercise_performance_snapshots (
  id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  user_id bigint(20) unsigned NOT NULL,
  exercise_id bigint(20) unsigned NOT NULL,
  ...
  UNIQUE KEY user_log_date (user_id,log_date)
			...
			/* ── Pantry Items ──────────────────────────────────────────────────── */
			"CREATE TABLE {$p}pantry_items (
  id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  user_id bigint(20) unsigned NOT NULL,
  item_name varchar(150) NOT NULL DEFAULT '',
  category_override varchar(50) DEFAULT NULL,
  ...
  KEY user_cookbook (user_id,is_cookbook)
			...
			/* ── Media Analysis Jobs ───────────────────────────────────────────── */
			"CREATE TABLE {$p}media_analysis_jobs (
  id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  user_id bigint(20) unsigned NOT NULL,
  ...
  KEY user_status (user_id,status)
			...
			/* ── Progress Photos ───────────────────────────────────────────────── */
			"CREATE TABLE {$p}progress_photos (
  id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  user_id bigint(20) unsigned NOT NULL,
  ...
  KEY channel_status_time (channel,status,created_at)
			...
			/* ── IronQuest Profiles ───────────────────────────────────────────── */
			"CREATE TABLE {$p}ironquest_profiles (
  id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  user_id bigint(20) unsigned NOT NULL,
  ...
  KEY current_location_slug (current_location_slug)
			...
			/* ── IronQuest Mission Runs ───────────────────────────────────────── */
			"CREATE TABLE {$p}ironquest_mission_runs (
  id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  user_id bigint(20) unsigned NOT NULL,
  ...
  KEY source_session (source_session_id)
			...
			/* ── IronQuest Unlocks ────────────────────────────────────────────── */
			"CREATE TABLE {$p}ironquest_unlocks (
  id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  user_id bigint(20) unsigned NOT NULL,
  ...
  KEY user_type_created (user_id,unlock_type,created_at)
			...
			/* ── IronQuest Daily State ────────────────────────────────────────── */
			"CREATE TABLE {$p}ironquest_daily_state (
  id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  user_id bigint(20) unsigned NOT NULL,
  ...
  KEY state_date (state_date)
			...
			/* ── IronQuest Activity Ledger ────────────────────────────────────── */
			"CREATE TABLE {$p}ironquest_activity_ledger (
  id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  user_id bigint(20) unsigned NOT NULL,
